    ...
    return (
        <div id="adminmenumain" role="navigation" aria-label="Main menu">
            ...
            <div id="adminmenuwrap">
                <ul id="adminmenu">
                    <li
                        className="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last"
                        id="menu-dashboard"
                    >
                        <a
                            href="index.php"
                    ...
                    <li
                        className="wp-not-current-submenu menu-top menu-icon-comments menu-top-last"
                        id="menu-comments"
                    >
                        <a
                        ...
                        <ul className="wp-submenu wp-submenu-wrap">
                            ...
                            <li>
                                <a href="site-editor.php">
                                    Editor{' '}
                                    <span className="awaiting-mod">beta</span>
                                </a>
                            </li>
                        </ul>
                    </li>
